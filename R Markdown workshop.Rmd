...
### Advantages
- Markdown can be used for everything. Eg. websites, documents, notes, books, presentations. 
...
-   eval: - Whether to evaluate the code chunk - eval = FALSE, show
    source code but do not run
...
```{r out.width ="50%", echo=TRUE}
 knitr::include_graphics("D:\\Courses\\2021 spring\\Computer programming in EDRE\\R\\EDRE 7610\\R Markdown\\Figure\\4.png")
```
