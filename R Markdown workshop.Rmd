...
# R Markdown Workshop
<font size="3">The primary purpose of this workshop is to introduce a free authoring framework for data science RMarkdown and to prepare workshop participants to use RMarkdown for teaching and research. </font>

1. <font size="3">Introduction</font>
2. <font size="3">R Markdown workflow: What and how</font>
3. <font size="3"> R Markdown content building: code, figure and table</font>
4. <font size="3">Different themes</font>
5. <font size="3">Tips</font>
---
...
<font size="3">For instructional purposes, R Markdown can create readable and portable PDF and HTML documents for students to use and make notes on devices such as iPad, smartphone. It also can display outputs straightforwardly, and make codes more organized in chunks, modules, etc. For learning purposes, R Markdown is easier to make notes and find bugs. For academic purposes, R Markdown is helpful for reproducible research manuscript, meeting strict guidelines on formatting journal articles and books, communicating with results with others, avoiding human errors, such as when copying output from R Studio to MS Word document, we do not need to worry about the format will be changed.</font>
...
- **R Markdown Cheatseet** <https://raw.githubusercontent.com/rstudio/cheatsheets/master/rmarkdown-2.0.pdf>
...
```{r prompt=TRUE,comment='',collapse=TRUE}
 sin(pi/2)
 cos(pi/2)
#distinguish code and results in output text, remove ##, collapse all code and results together  
```
...
-   result
    ...
    -   hold: Hold all pieces of text output in a chunk and flush them
...
-   fig.show:
    ...
    -   asis: display plot behind the code

    -   hold: display plots behind the code chunk
...
-   fig.width: for R-generated figures only

-   fig.height: for R-generated figures only
...
-   fig.subcap: set subtitle

```{r out.width="80%", fig.cap="Figure 1", fig.subcap="This is a plot", echo = TRUE}
 plot(1:10)
```
...
- **Hugo acadmic theme demo**: <https://academic-demo.netlify.app/>

## Create slide
- **xaringan package** : <https://github.com/yihui/xaringan>
